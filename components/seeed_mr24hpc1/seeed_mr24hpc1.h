...
class MR24HPC1Component : public PollingComponent,
 ...
 protected:
  ...
  uint8_t s_output_info_switch_flag;
  uint8_t sg_recv_data_state;
  uint8_t sg_frame_len;
  uint8_t sg_data_len;
  uint8_t sg_frame_buf[FRAME_BUF_MAX_SIZE];
  uint8_t sg_frame_prase_buf[FRAME_BUF_MAX_SIZE];
