...
# 这个 mr24hpc1Sensor 类将是一个定期轮询的 UART 设备
mr24hpc1Sensor = mr24hpc1_ns.class_('mr24hpc1Sensor', cg.PollingComponent, uart.UARTDevice)
...
CONFIG_SCHEMA = sensor.sensor_schema(UNIT_EMPTY, ICON_EMPTY, 1).extend({
    cv.GenerateID(): cv.declare_id(mr24hpc1Sensor),
